...
feature 'Frontend calculations' do
  ...
  feature "filling calculations in front end from scratch", js: true do
    ...
    feature "INTEGRATED: percent calculations" do
      ...
      feature "1 team" do
        feature "1 source (3 employees) + 1 nonsource employee + no tips" do
          before :each do
            ...
            within("#percentage #positions-table") do
              ...
              find(:css, ".total-position-tips[data-position-type='#{ not_source_position_first.name }'] .percentage-point").set '25'
            end
          ...
          scenario "should have right totals table" do
            within("#total-block") do
              ...
              expect(page).to have_css ".cash-out-total", text: '600'
              ...
              expect(page).to have_css ".tips-distributed-cash", text: '600'
              expect(page).to have_css ".tips-to-distribute-cc", text: '300'
              expect(page).to have_css ".tips-to-distribute-cash", text: '600'
              expect(page).to have_css ".hours", text: '4'
            end
          end

          scenario "should have right employee calculations" do
            within(".employee-distribution-line[data-employee-id='#{ source_position.employees.first.id }']") do
              expect(page).to have_css ".cc-out", text: '75'
              expect(page).to have_css ".cash-out", text: '150'
              expect(page).to have_css ".final-tips-distributed-cc", text: '75'
              expect(page).to have_css ".final-tips-distributed-cash", text: '150'
            end
            within(".employee-distribution-line[data-employee-id='#{ source_position.employees.second.id }']") do
              expect(page).to have_css ".cc-out", text: '75'
              expect(page).to have_css ".cash-out", text: '150'
          ...
          feature "when save button clicked" do
          end
        end
        ...
        feature "3 source employees + 6 nonsource employees (2 teams) + 2 given tip outs + 1 received" do
          ...
          before :each do
            ...
            within("#percentage #positions-table") do
              find(:css, ".total-position-tips[data-position-type='#{ source_position.name }'] .percentage-point").set '40'
              find(:css, ".total-position-tips[data-position-type='#{ not_source_position_first.name }'] .percentage-point").set '25'
              find(:css, ".total-position-tips[data-position-type='#{ not_source_position_second.name }'] .percentage-point").set '15'
            end
